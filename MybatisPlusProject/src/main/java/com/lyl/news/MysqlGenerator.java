...
public class MysqlGenerator {
    ...
    public static void main(String[] args) {
        ...
        //生成的路径
        gc.setOutputDir(projectPath + "/MybatisPlusProject/src/main/java");
        //作者
        gc.setAuthor("lyl");
        gc.setOpen(false);
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/newsdb?useUnicode=true&useSSL=false&characterEncoding=utf8" +
